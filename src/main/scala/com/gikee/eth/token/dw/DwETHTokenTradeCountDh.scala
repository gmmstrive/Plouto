...
object DwETHTokenTradeCountDh {
  ...
  def main(args: Array[String]): Unit = {
    ...
    readDatabase = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.readDatabase")
    readTableName = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.readTableName")
    readDmDatabase = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.readDmDatabase")
    readDmTableName = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.readDmTableName")
    writeDataBase = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.writeDataBase")
    writeTableName = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.writeTableName")
    transactionDate = spark.sparkContext.getConf.get("spark.dwETHTokenTradeCountDh.transactionDate")

    getDwETHTokenTradeCountDh(spark)

    spark.stop()

  }

  def getDwETHTokenTradeCountDh(spark: SparkSession): Unit = {
